...
predictor = dlib.shape_predictor(r'C:\Users\Lenovo\OneDrive\Desktop\BlinkMorse\final\models\shape_predictor_68_face_landmarks.dat')
...
while True:
    ...
    for face in faces:
        ...
        if not blink_active and (current_time - last_blink_end_time) > 2.0 and final_text and final_text[-1] != ' ':
            final_text += ' '
